...
export default function MovementHistory() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const data = await fetchAllTableRows("/pos/inventory/stock-movements", authFetch);
      setRows(data);
    } catch {
      setRows([]);
    } finally {
  ...
  return (
    <div className="wh-page">
      <PageHeader
        ...
        description="Complete audit trail of all POS stock movements including initial stock, stock in/out, and transfers."
      />
