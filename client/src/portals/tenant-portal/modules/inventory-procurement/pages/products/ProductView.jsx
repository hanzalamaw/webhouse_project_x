...
export default function ProductView() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setDeleteOpen(false);
      navigate(`${MODULE_BASE}/products/manage`);
    } catch (e) {
      setError(e.message);
      setDeleteOpen(false);
    } finally {
  ...
  return (
    <div className="wh-page wh-page--wide">
          ...
          <div className="wh-action-btns">
            ...
            {canDelete && (
              <Button
                ...
                disabled={(product.open_order_count || 0) > 0}
                title={(product.open_order_count || 0) > 0 ? "Products on open orders cannot be deleted." : undefined}
              >
                Delete
              </Button>
            )}
      ...
      <ConfirmDeleteModal
        ...
        recordName={product.product_name || "this product"}
