...
import { MODULE_BASE, CUSTOMER_TYPES, CUSTOMER_STATUSES, CUSTOMER_TYPE_LABELS, ACTIVE_CUSTOMER_DAYS } from "../../constants";
...
export default function ManageCustomers() {
  ...
  const columns = [
    ...
    { key: "customer_type", label: "Type", format: (v) => CUSTOMER_TYPE_LABELS[v] || v },
    ...
    { key: "created_at", label: "Created", format: formatDateTime },
    {
      ...
      render: (row) => (
        <div className="wh-action-btns">
          <Button variant="secondary" className="wh-btn--sm" onClick={() => navigate(`${MODULE_BASE}/customers/${row.id}`)}>View</Button>
  ...
  return (
    <div className="wh-page">
      <PageHeader
        title="Customers"
        description={`Customer profiles with tags and status. Recently active = ordered in the last ${ACTIVE_CUSTOMER_DAYS} days.`}
        actions={
          <div className="wh-action-btns">
